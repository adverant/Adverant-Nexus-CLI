 ...
 */
export type WorkspaceConfigZ = z.infer<typeof WorkspaceConfigSchema>;
export type ServicesConfigZ = z.infer<typeof ServicesConfigSchema>;
export type AuthConfigZ = z.infer<typeof AuthConfigSchema>;
export type DefaultsConfigZ = z.infer<typeof DefaultsConfigSchema>;
export type AgentConfigZ = z.infer<typeof AgentConfigSchema>;
export type PluginsConfigZ = z.infer<typeof PluginsConfigSchema>;
export type MCPConfigZ = z.infer<typeof MCPConfigSchema>;
export type ShortcutZ = z.infer<typeof ShortcutSchema>;
export type NexusConfigZ = z.infer<typeof NexusConfigSchema>;
export type ProfileZ = z.infer<typeof ProfileSchema>;
export type GlobalConfigZ = z.infer<typeof GlobalConfigSchema>;
