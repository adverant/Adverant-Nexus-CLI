...
import type { SessionSummary } from '@adverant-nexus/types';
 ...
 */
function displaySessionsTable(sessions: SessionSummary[]): void {
 ...
 */
function displaySessionsText(sessions: SessionSummary[]): void {
