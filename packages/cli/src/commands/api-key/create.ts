...
import type { CreateAPIKeyRequest } from '@adverant-nexus/types';
      ...
      try {
        ...
        try {
          ...
          await credentialsManager.saveAPIKeyReference({
            ...
            organization_id: currentOrgId,
            ...(request.rate_limit_rpm !== undefined && { rate_limit_rpm: request.rate_limit_rpm }),
            ...(request.allowed_ips !== undefined && { allowed_ips: request.allowed_ips }),
            ...(request.allowed_services !== undefined && { allowed_services: request.allowed_services }),
