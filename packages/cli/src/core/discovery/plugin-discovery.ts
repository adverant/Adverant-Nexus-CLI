 ...
 * Plugin Discovery
 *
 * Auto-discovers user plugins from ~/.nexus/plugins/ directory
...
import type { Plugin, PluginManifest, PluginCommand } from '../../types/index.js';

/**
 * Plugin discovery configuration options
 */
export interface PluginDiscoveryOptions {
  /** Plugin directory path (defaults to ~/.nexus/plugins) */
  pluginDir?: string;
 ...
 * @param validateStructure - Whether to validate directory structure
 * @returns Loaded plugin
 * @throws Error if plugin cannot be loaded or is invalid
 */
 ...
 * Load plugin.json manifest
 *
 * @param manifestPath - Path to plugin.json file
 * @returns Parsed plugin manifest
 * @throws Error if manifest cannot be loaded or parsed
 */
 ...
 */
function validateCommand(command: import('../../types/index.js').PluginCommandDef): void {
  if (!command.name) {
 ...
 *
 * @param arg - Argument definition to validate
 ...
 * @param availableServices - Set of available service names
 ...
 * @param allowedPermissions - Set of allowed permission strings
 ...
 * @returns Map of plugin names to their commands
 */
 ...
 * @returns Filtered array of matching plugins
 */
 ...
 *
 * @param plugins - Array of plugins to group
 * @returns Map of categories to plugins
 */
 ...
 *
 * @param plugins - Array of plugins
 * @returns Statistics about plugins
 */
